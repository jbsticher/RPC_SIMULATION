...
background_image = pygame.image.load('./items/game_field.jpg')
background_image = pygame.transform.scale(background_image, (WINDOW_WIDTH, WINDOW_HEIGHT))

# load and scale entity icons
rock_icon = pygame.image.load('./items/rock.png')
rock_icon = pygame.transform.scale(rock_icon, (ICON_WIDTH, ICON_HEIGHT))

paper_icon = pygame.image.load('./items/game_paper.png')
paper_icon = pygame.transform.scale(paper_icon, (ICON_WIDTH, ICON_HEIGHT))

scissors_icon = pygame.image.load('./items/scissors.png')
